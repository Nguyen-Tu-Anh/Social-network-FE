...
// New submit show-post box
	...
	$("[type = submit]").click(function () {
	    ...
	    $("<p class='show-post'>" + post + "</p>").appendTo("section");
	});
...
// show comments
	$('.comment').on('click', function () {
		$(this).parents(".show-post-meta").siblings(".coment-area").slideToggle("slow");
	});

// add / show-post location
	$('.add-loc').on('click', function () {
		$('.add-location-show-post').slideToggle("slow");
	});
...
//save show-post click
$('.save-show-post, .bane, .get-link').on("click", function() {
...
/** Post a Comment **/
jQuery(".show-post-comt-box textarea").on("keydown", function(event) {
